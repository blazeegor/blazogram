...
from ..types.inline_keyboard import InlineKeyboardMarkup, InlineKeyboardButton, InlineKeyboard, InlineKeyboardLine
...
class Methods:
    ...
    async def GetUpdates(self, offset: Optional[int], allowed_updates: Optional[list]) -> list[Update]:
            ...
            for update in data['result']:
                if 'message' in update:
                    ...
                    if 'reply_markup' in message:
                        ...
                        message['reply_markup'] = InlineKeyboardMarkup(inline_keyboard=inline_keyboard)
    ...
    async def DeleteMessage(self, chat_id: int, message_id: int):
        ...
        response = await self.session.get(url=f'https://api.telegram.org/bot{self.bot.token}/deleteMessage', data=data)
